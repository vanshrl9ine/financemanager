...
const SEED_USER_ID = "user_2kN5VUvssrkhokSwp4A1WTIuJGr";
...
const main = async () => {
    try {
        ...
        // Debug: Check if SEED_TRANSACTIONS is populated
        console.log("Generated Transactions:", SEED_TRANSACTIONS.length);
